...
namespace FIX43
{
                              ...
                              const FIX::SessionID& sessionID )
  {
    ...
    if( msgTypeValue == "P" )
      return crackConst<AllocationAck>( *this, message, sessionID );
    if( msgTypeValue == "Q" )
    ...
    if( msgTypeValue == "AC" )
      return crackConst<MultilegOrderCancelReplaceRequest>( *this, message, sessionID );
    if( msgTypeValue == "AD" )
                              ...
                              const FIX::SessionID& sessionID )
  {
    ...
    if( msgTypeValue == "P" )
      return crackMutable<AllocationAck>( *this, message, sessionID );
    if( msgTypeValue == "Q" )
    ...
    if( msgTypeValue == "AC" )
      return crackMutable<MultilegOrderCancelReplaceRequest>( *this, message, sessionID );
    if( msgTypeValue == "AD" )
