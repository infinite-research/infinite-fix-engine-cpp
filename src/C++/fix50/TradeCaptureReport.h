...
namespace FIX50
{
  ...
  public:
    ...
    TradeCaptureReport(const TradeCaptureReport&) = default;
    TradeCaptureReport(TradeCaptureReport&&) = default;
    TradeCaptureReport& operator=(const TradeCaptureReport&) = default;
    TradeCaptureReport& operator=(TradeCaptureReport&&) = default;
    ...
    {
    public:
    NoLegs() : FIX::Group(555,600,FIX::message_order(600,601,602,603,607,608,609,764,610,611,248,249,250,251,252,253,257,599,596,597,598,254,612,942,613,614,999,1001,615,616,617,618,619,620,621,622,623,624,556,740,739,955,956,1017,566,687,690,990,683,564,565,539,654,566,587,588,637,675,1073,1074,1075,0)) {}
