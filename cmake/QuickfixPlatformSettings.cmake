...
if(NOT WIN32)
  ...
  if(NOT IRFQ_INFINITE_EMBED_DICTIONARIES
     AND EXISTS "${PROJECT_SOURCE_DIR}/src/C++/Allocator.h")
    configure_file("${PROJECT_SOURCE_DIR}/src/C++/Allocator.h"
                   "${PROJECT_BINARY_DIR}/include/quickfix/Allocator.h" COPYONLY)
  else()
    file(WRITE "${PROJECT_BINARY_DIR}/include/quickfix/Allocator.h"
